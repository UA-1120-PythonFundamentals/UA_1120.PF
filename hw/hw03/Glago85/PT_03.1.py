...
substr = 'better'
print(f'The word/symbol \"{substr}\" was used = {str.count(substr,256,313)} times in the given range (Line 9)')

substr = 'never'
print(f'The word/symbol \"{substr}\" was used = {str.count(substr)} times in text')

substr = 'is'
print(f'The word/symbol \"{substr}\" was used = {str.count(substr)} times in text', end='\n\n')
